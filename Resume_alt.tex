...
\section{Research \& Projects}
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        \resumeItem{Designed and developed an automated line-judging system to make accurate in/out calls in volleyball.}
        \resumeItem{Engineered a computer vision pipeline using OpenCV to capture and process real-time court imagery, identifying ball position relative to court boundaries to enhance officiating accuracy.}
      \resumeItemListEnd
